        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            function welcome_message() {
              ...
              echo -e "\n\033[1;34m Database Commands:\033[0m"
              echo -e "  🚀 psql <db_name>    - Connect to PostgreSQL"
              echo -e "  🚀 pg_logs           - View PostgreSQL logs (live)"
              echo -e "  🚀 pg_start          - Start PostgreSQL localserver"
              echo -e "  🚀 pg_stop           - Stop PostgreSQL localserver"
              ...
              echo -e "\n  🚀 fastapi_start     - Start FastAPI service"
              echo -e "  🚀 all_start         - Start all services (Postgres, Nginx)"
